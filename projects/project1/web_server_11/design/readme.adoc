...
The following diagram shows the design for the first version of the concurrent web server, using two clients' requests to show how requests will be responded for both Prime Factorization and Goldbach Sums web apps. Note that inheritances involving new, important classes are attached in the surroundings of the process diagram.
